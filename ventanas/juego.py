...
DISPARO_FALLADO = "-"
DISPARO_ACERTADO = "*"
DISPAROS_INICIALES = 1000000
CANTIDAD_BARCOS_INICIALES = 9
JUGADOR_1 = "J1"
JUGADOR_2 = "J2"
...
def acerca_de():
    instrucciones = """
1.Tienes solo 10 disparos 
2.los barcos se generan de manera aleatorea 
3.Es por turnos, asi que se imprimirá el tablero correspondiente al rival
    """
    print(instrucciones)
